...
import watchScreen from '@/assets/images/watchscreen.webp';
import tabletOnHand from '@/assets/images/tabletonahand.webp';

const Tablet = ({ children }) => {
  return (
    <div className="flex justify-end w-3xl sm:w-full sm:h-full overflow-hidden">
      <div
        className={`bg-[url(${watchScreen})] sm:bg-[url(${tabletOnHand})] bg-contain bg-no-repeat bg-center md:h-[400px] sm:bg-right sm:w-[500px] sm:h-[400px] w-[800px] h-[300px] relative
